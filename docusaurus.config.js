...
const config = {
  title: 'SwiftUI Modifiers Handbook',
  tagline: 'A super friendly visual guide to SwiftUI Modifiers',
  ...
  baseUrl: '/swiftui-modifiers-handbook-site/',
  ...
  themeConfig:
    ...
    ({
      colorMode: {
        ...
        respectPrefersColorScheme: false, // ignores system settings
      },
